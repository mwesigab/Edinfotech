        ...
        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="date" class="form-control" id="fdate" name="fdate" value="{!! $_GET['fdate'] ?? '' !!}">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="date" class="form-control" id="ldate" name="ldate" value="{!! $_GET['ldate'] ?? '' !!}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" placeholder="Minimum User Balance" name="withdraw" value="{!! $_GET['withdraw'] ?? '' !!}" class="form-control text-center">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
            ...
            @if(count($users)>0)
                <div class="col-md-12 col-xs-12 alert alert-success">
                    ...
                    <span class="f-w-b">{{{ $allsum ?? 0 }}}</span>
                ...
                <tbody>
                    @foreach($users as $user)
                        ...
                        <tr>
                            ...
                            <th class="text-center number-green" width="100" @if($user->income<0) style="color:red !important;" @endif>{{{ $user->income ?? 0 }}}</th>
                            <th class="text-center">{{{ $meta['bank_name'] ?? '' }}}</th>
                            <th class="text-center">{{{ $meta['bank_card'] ?? '' }}}</th>
                            <th class="text-center">{{{ $meta['bank_account'] ?? '' }}}</th>
                ...
                <tbody>
                    @foreach($users_not_apply as $user)
                        ...
                        <tr>
                            ...
                            <th class="text-center">{{{ $meta['bank_account'] ?? '' }}}</th>
                            <th class="text-center">
                                <a href="/admin/notification/new?recipent_type=userone&uid={{{ $user->id ?? 0 }}}" title="Send notification"><i class="fa fa-bell-o" aria-hidden="true"></i></a>
                                <a href="/admin/balance/new/?user={{{ $user->id }}}" title="Create financial doc."><i class="fa fa-line-chart" aria-hidden="true"></i></a>
                            </th>
                        </tr>
                    @endforeach
