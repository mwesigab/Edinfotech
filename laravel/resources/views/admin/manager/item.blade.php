                    ...
                    <div id="main" class="tab-pane active">
                        <form action="/admin/user/edit/{{{$user->id}}}" class="form-horizontal form-bordered" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" value="{{{ decrypt($user->password) }}}"  id="inputReadOnly" class="form-control text-left" dir="ltr" readonly="readonly">
                                </div>
                            </div>
                        ...
                        <form action="/admin/manager/capatibility/{{{$user->id}}}" class="form-horizontal form-bordered" method="post">
                            ...
                            <div class="custom-switches-stacked">
                                <label class="custom-switch">
                                    <input type="checkbox" name="capatibility[]" value="school" class="custom-switch-input" @if(!empty($meta['capatibility'])) {{{ checkedInArray('school',$meta['capatibility'],true) }}} @endif />
                                    <span class="custom-switch-indicator"></span>
                                    <label class="custom-switch-description" for="inputDefault">{{{ trans('admin.school') }}}</label>
                                </label>
                                <label class="custom-switch">
