        ...
        <div class="multi-steps">
            <div class="col-md-3 col-xs-12 col-sm-4 tab-con right-side">
                <ul>
                    ...
                    <li cstep="2"><a href="javascript:void(0);"><i class="upicon mdi mdi-apps"></i><span>{{{ trans('main.category') }}}</span></a>
                    </li>
                    <li cstep="3"><a href="javascript:void(0);"><i class="upicon mdi mdi-library-books"></i><span>{{{ trans('main.extra_info') }}}</span></a>
                    </li>
                    <li cstep="4"><a href="javascript:void(0);"><i class="upicon mdi mdi-folder-image"></i><span>{{{ trans('main.view') }}}</span></a>
                    </li>
                    <li cstep="5"><a href="javascript:void(0);"><i class="upicon mdi mdi-movie-open"></i><span>{{{ trans('main.parts') }}}</span></a>
                    </li>
                </ul>
            </div>
            <div class="col-md-9 col-xs-12 col-sm-8 tab-con left-side">
                <div class="steps" id="step1">
                    <form method="post" id="step-1-form" class="form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-md-2 tab-con" for="inputDefault">{{{
                                trans('main.course_type') }}}</label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2 tab-con" for="inputDefault">{{{
                                trans('main.education_level') }}}</label>
                            <div class="col-md-10 tab-con">
                                <select name="education_level" class="form-control font-s" id="education_level">
                                    <option>Select--</option>
                                    <option value="1" @if(isset($item) && $item->education_level == '1') selected
                                        @endif>{{{ trans('main.education_level_one') }}}
                                    </option>
                                    <option value="2" @if(isset($item) && $item->education_level == '2') selected
                                        @endif>{{{ trans('main.education_level_two') }}}
                                    </option>
                                    <option value="3" @if(isset($item) && $item->education_level == '3') selected
                                        @endif>{{{ trans('main.education_level_three') }}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        @if(isset($item) && $item->education_level == '1')
                        <div class="form-group" id="primary_classes">
                            <label class="control-label col-md-2 tab-con" for="inputDefault">{{{ trans('main.class')
                                }}}</label>
                            <div class="col-md-10 tab-con">
                                <select name="study_class" class="form-control font-s">
                                    <option>Select--</option>
                                    <option value="7" @if($item->study_class == '7') selected @endif>{{{
                                        trans('main.class_seven') }}}
                                    </option>
                                    <option value="6" @if($item->study_class == '6') selected @endif>{{{
                                        trans('main.class_six') }}}
                                    </option>
                                    <option value="5" @if($item->study_class == '5') selected @endif>{{{
                                        trans('main.class_five') }}}
                                    </option>
                                    <option value="4" @if($item->study_class == '4') selected @endif>{{{
                                        trans('main.class_four') }}}
                                    </option>
                                    <option value="3" @if($item->study_class == '3') selected @endif>{{{
                                        trans('main.class_three') }}}
                                    </option>
                                    <option value="2" @if($item->study_class == '2') selected @endif>{{{
                                        trans('main.class_two') }}}
                                    </option>
                                    <option value="1" @if($item->study_class == '1') selected @endif>{{{
                                        trans('main.class_one') }}}
                                    </option>
                                    <option value="8" @if($item->study_class == '8') selected @endif>{{{
                                        trans('main.elementary_three') }}}
                                    </option>
                                    <option value="9" @if($item->study_class == '9') selected @endif>{{{
                                        trans('main.elementary_two') }}}
                                    </option>
                                    <option value="10" @if($item->study_class == '10') selected @endif>{{{
                                        trans('main.elementary_one') }}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        @endif
                        @if(isset($item) && $item->education_level == '2')
                        <div class="form-group" id="secondary_classes">
                            ...
                            <div class="col-md-10 tab-con">
                                <select name="study_class" class="form-control font-s">
                                    <option>Select--</option>
                                    <option value="6" @if($item->study_class == '6') selected @endif>{{{
                                        trans('main.senior_six') }}}
                                    </option>
                                    <option value="5" @if($item->study_class == '5') selected @endif>{{{
                                        trans('main.senior_five') }}}
                                    </option>
                                    <option value="4" @if($item->study_class == '4') selected @endif>{{{
                                        trans('main.senior_four') }}}
                                    </option>
                                    <option value="3" @if($item->study_class == '3') selected @endif>{{{
                                        trans('main.senior_three') }}}
                                    </option>
                                    <option value="2" @if($item->study_class == '2') selected @endif>{{{
                                        trans('main.senior_two') }}}
                                    </option>
                                    <option value="1" @if($item->study_class == '1') selected @endif>{{{
                                        trans('main.senior_one') }}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        @if(isset($item) && $item->education_level == '3')
                        <div class="form-group" id="university_classes">
                            ...
                            <div class="col-md-10 tab-con">
                                <select name="study_class" class="form-control font-s">
                                    <option>Select--</option>
                                    <option value="6" @if($item->study_class == '6') selected @endif>{{{
                                        trans('main.sixth_year') }}}
                                    </option>
                                    <option value="5" @if($item->study_class == '5') selected @endif>{{{
                                        trans('main.fifth_year') }}}
                                    </option>
                                    <option value="4" @if($item->study_class == '4') selected @endif>{{{
                                        trans('main.fourth_year') }}}
                                    </option>
                                    <option value="3" @if($item->study_class == '3') selected @endif>{{{
                                        trans('main.third_year') }}}
                                    </option>
                                    <option value="2" @if($item->study_class == '2') selected @endif>{{{
                                        trans('main.second_year') }}}
                                    </option>
                                    <option value="1" @if($item->study_class == '1') selected @endif>{{{
                                        trans('main.first_year') }}}
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <textarea class="form-control editor-te editor-te-h"
                                          placeholder="You can import HTML..." name="content" required>{!! $item->content or '' !!}</textarea>
                            </div>
                        </div>
                    </form>
                ...
                <div class="steps dnone" id="step2">
                    <form method="post" id="step-2-form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label tab-con" for="inputDefault">{{{ trans('main.tags')
                                }}}</label>
                            <div class="col-md-10 tab-con">
                                <input type="text" data-role="tagsinput" placeholder="Press enter to save tag."
                                       name="tag" value="{{{ $item->tag or ''}}}" class="form-control text-center">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label tab-con" for="inputDefault">{{{ trans('main.category')
                                }}}</label>
                            <div class="col-md-10 tab-con">
                                <select name="category_id" id="category_id" class="form-control font-s" required>
                                    ...
                                    <optgroup label="{{{ $menu->title or '' }}}">
                                        ...
                                        <option value="{{{ $sub->id or '' }}}" @if($sub->id == $item->category_id)
                                            selected @endif>{{{ $sub->title or '' }}}
                                        </option>
                                        @endforeach
                                        @else
                                        <option value="{{{ $menu->id or '' }}}" @if($menu->id == $item->category_id)
                                            selected @endif>{{{ $menu->title or '' }}}
                                        </option>
                                        @endif
                                    </optgroup>
                                    @endif
                        ...
                        <div class="col-md-11 col-md-offset-1 tab-con filters dnone" @if($menu->id !=
                            $item->category_id) class="dnone" @endif id="filter{{{ $menu->id or 0 }}}">
                                ...
                                <ul class="cat-filters-li pamaz">
                                    <ul class="submenu submenu-s">
                                        ...
                                        <li class="second-input"><input type="checkbox" class="filter-tags dblock"
                                                                        id="tag{{{ $tag->id or '' }}}" name="filters[]"
                                                                        value="{{{ $tag->id or 0 }}}" @if(isset($item->filters)
                                            && in_array($tag->id,$item->filters->pluck('id')->toArray())) checked
                                            @endif><label for="tag{{{ $tag->id or '' }}}"><span></span>{{{ $tag->tag or
                                                '' }}}</label></li>
                                        @endforeach
                                    </ul>
                                </ul>
                ...
                <div class="steps dnone" id="step3">
                    <form method="post" id="step-3-form" class="form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-md-5 tab-con col-md-offset-1 dinb" " for="inputDefault">{{{
                            trans('main.free_course') }}}</label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-5 tab-con col-md-offset-1 dinb">{{{
                                trans('main.vendor_postal_sale') }}}</label>
                            <div class="col-md-6 tab-con">
                        ...
                        <div class="form-group">
                            <label class="control-label tab-con col-md-5 col-md-offset-1 dinb" for="inputDefault">{{{
                                trans('main.support') }}}</label>
                            <div class="col-md-6 tab-con">
                                <div class="switch switch-sm switch-primary pull-left">
                                    <input type="hidden" value="0" name="support">
                                    <input type="checkbox" name="support" value="1" data-plugin-ios-switch @if($item->support
                                    == 1) checked="checked" @endif />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label tab-con col-md-5 col-md-offset-1 dinb" for="inputDefault">{{{
                                trans('main.download') }}}</label>
                            <div class="col-md-6 tab-con">
                                <div class="switch switch-sm switch-primary pull-left">
                                    <input type="hidden" value="0" name="download">
                                    <input type="checkbox" name="download" value="1" data-plugin-ios-switch @if($item->download
                                    == 1) checked="checked" @endif />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price" onkeypress="validate(event)"
                                           value="{{{$meta['price'] or ''}}}" class="form-control text-center numtostr"
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="post_price" onkeypress="validate(event)"
                                           value="{{{$meta['post_price'] or ''}}}"
                                           class="form-control text-center numtostr" @if($item->post != 1) disabled
                                    @endif>
                                    <span class="input-group-addon click-for-upload img-icon-s">{{{ currencySign() }}}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price_3" onkeypress="validate(event)"
                                           value="{{{ $item->price_3 or ''}}}" class="form-control text-center">
                                    <span class="input-group-addon click-for-upload img-icon-s">{{{ currencySign() }}}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price_6" onkeypress="validate(event)"
                                           value="{{{ $item->price_6 or ''}}}" class="form-control text-center">
                                    <span class="input-group-addon click-for-upload img-icon-s">{{{ currencySign() }}}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price_9" onkeypress="validate(event)"
                                           value="{{{ $item->price_9 or ''}}}" class="form-control text-center">
                                    <span class="input-group-addon click-for-upload img-icon-s">{{{ currencySign() }}}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price_12" onkeypress="validate(event)"
                                           value="{{{ $item->price_12 or ''}}}" class="form-control text-center">
                                    <span class="input-group-addon click-for-upload img-icon-s">{{{ currencySign() }}}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body no-absolute-content">
                                    <form method="post" id="step-3-form-precourse">
                                        <input type="hidden" name="precourse" id="precourse"
                                               value="{{{ $meta['precourse'] or '' }}}">
                                    </form>
                                    <ul class="pre-course-title-container">
                                        @foreach($preCourse as $prec)
                                        <li>{{{ $prec->title or '' }}}&nbsp;(VT-{{{ $prec->id or 0 }}})<i
                                                    class="fa fa-times delete-course" cid="{{{ $prec->id or 0 }}}"></i>
                                        </li>
                                        @endforeach
                                    </ul>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-custom pull-left" data-dismiss="modal">{{{
                                        trans('main.close') }}}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10 tab-con">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="cover" placeholder="Prefered :410*730px" dir="ltr"
                                           value="{{{$meta['cover'] or ''}}}" class="form-control">
                            ...
                            <div class="col-md-10 tab-con">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="video" placeholder="Prefered :1-3 mins" dir="ltr"
                                           value="{{{$meta['video'] or ''}}}" class="form-control">
                                    <span class="input-group-addon click-for-upload img-icon-s"><span
                                                class="formicon mdi mdi-arrow-up-thick"></span></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10 tab-con">
                                <div class="input-group document-input">
                                    ...
                                    <input type="text" name="document" id="document-addon" dir="ltr"
                                           value="{{{$meta['document'] or ''}}}" class="form-control">
                    ...
                    <div class="accordion-off">
                        <ul id="accordion" class="accordion off-filters-li">
                            <li class="open edit-part-section dnone">
                                <div class="link edit-part-click"><h2>{{{ trans('main.edit_part') }}}</h2><i
                                ...
                                <div class="submenu dblock">
                                    ...
                                    <form action="/user/content/part/edit/store/" id="step-5-form-edit-part"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label tab-con col-md-2">{{{ trans('main.video_file')
                                                }}}</label>
                                            ...
                                            <label class="control-label col-md-1 tab-con">{{{ trans('main.sort')
                                                }}}</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-2 tab-con">{{{ trans('main.volume')
                                                }}}</label>
                                            ...
                                            <label class="control-label col-md-1 tab-con">{{{ trans('main.duration')
                                                }}}</label>
                                            <div class="col-md-3 tab-con">
                                                <div class="input-group">
                                            ...
                                            <label class="control-label col-md-1 tab-con">{{{ trans('main.free')
                                                }}}</label>
                                            <div class="col-md-2 tab-con">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label tab-con col-md-2" for="inputDefault">{{{
                                                trans('main.title') }}}</label>
                                            <div class="col-md-8 tab-con">
                                                <input type="text" name="title" class="form-control" required>
                                            </div>
                                            <div class="col-md-2 tab-con">
                                                <button class="btn btn-custom pull-left" id="edit-part-submit"
                                                        type="submit">{{{ trans('main.edit_part') }}}
                                                </button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <li class="open">
                                <div class="link new-part-click"><h2>{{{ trans('main.new_part') }}}</h2><i
                                            class="mdi mdi-chevron-down"></i></div>
                                <div class="submenu dblock">
                                    <div class="h-15"></div>
                                    <form action="/user/content/part/store" id="step-5-form-new-part" method="post"
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-2 tab-con">{{{ trans('main.video_file')
                                                }}}</label>
                                            <div class="col-md-7 tab-con">
                                                <div class="input-group">
                                                    <span class="input-group-addon view-selected img-icon-s"
                                            ...
                                            <label class="control-label tab-con col-md-1">{{{ trans('main.sort')
                                                }}}</label>
                                            <div class="col-md-2 tab-con">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label tab-con col-md-2">{{{ trans('main.volume')
                                                }}}</label>
                                            <div class="col-md-3 tab-con">
                                                <div class="input-group">
                                                    <input type="number" min="0" name="size"
                                            ...
                                            <label class="control-label tab-con col-md-1">{{{ trans('main.duration')
                                                }}}</label>
                                            <div class="col-md-3 tab-con">
                                                <div class="input-group">
                                                    <input type="number" min="0" name="duration"
                                            ...
                                            <label class="control-label tab-con col-md-1">{{{ trans('main.free')
                                                }}}</label>
                                            <div class="col-md-2 tab-con">
                                                <div class="switch switch-sm switch-primary pull-left">
                                                    <input type="hidden" value="0" name="free">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 tab-con">
                                                <button class="btn btn-custom tab-con pull-left" id="new-part"
                                                        type="submit">{{{ trans('main.save_changes') }}}
                                                </button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <li>
                                <div class="link list-part-click"><h2>{{{ trans('main.parts') }}}</h2><i
                                            class="mdi mdi-chevron-down"></i></div>
                                <div class="submenu">
            ...
            <div class="h-10"></div>
            <div class="col-md-12">
                <a href="javascript:void(0);" class="btn btn-custom pull-left tab-con marl-s-10" id="prev-btn">{{{
                    trans('main.previous') }}}</a>
                <a href="javascript:void(0);" class="btn btn-custom tab-con pull-left marl-s-10" id="next-btn">{{{
                    trans('main.next') }}}</a>

                @if($item->mode != 'publish')
                <a href="#publish-modal" data-toggle="modal" class="btn btn-custom pull-left tab-con marl-s-10">{{{
                    trans('main.publish') }}}</a>
                @else
                <a href="#re-publish-modal" data-toggle="modal" class="btn btn-custom pull-left tab-con marl-s-10">{{{
                    trans('main.save_changes') }}}</a>
                @endif
                @if($item->mode != 'publish')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-custom pull-left" id="delete-request">{{{ trans('main.yes_sure')
                    }}}
                </button>
            </div>
        </div><!-- /.modal-content -->
