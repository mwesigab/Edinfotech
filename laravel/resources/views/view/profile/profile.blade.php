...
<div class="container-fluid profile-top-background" style="background: url('{{{ $meta['profile_image'] ?? get_option('default_user_cover','') }}}');">
    ...
    <div class="col-md-9 col-xs-12 bottom-section">
            ...
            @endif
                <label class="buttons"><span class="homeicon mdi mdi-account-heart"></span><p>{{{ $follow_count ?? '0' }}}&nbsp;{{{ trans('main.followers') }}}</p></label>
...
<div class="container-fluid profile-middle-background">
    <div class="container">
        <div class="col-md-2 col-xs-12 profile-avatar-container tab-con">
            <img class="sbox3" src="{{{ $meta['avatar'] ?? get_option('default_user_avatar','') }}}"/>
            ...
            <div id="t-biography" class="profile-section-fade profile-section sbox3 doview">
                <div class="row">
                    <div class="col-md-3 col-xs-12 col-sm-6 text-center">
                        ...
                        <div class="h-5"></div>
                        <span class="dis-block">({{{ $video_rate ?? 0 }}})</span>
                        <div class="h-10"></div>
                    ...
                    <div class="col-md-3 col-xs-12 col-sm-6 text-center">
                        ...
                        <div class="h-5"></div>
                        <span class="dis-block">({{{ $support_rate ?? 0 }}})</span>
                        <div class="h-10"></div>
                        <div class="progress" dir="ltr">
                            <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="{{{ $support_rate ?? 0 }}}"
                    ...
                    <div class="col-md-3 col-xs-12 col-sm-6 text-center">
                        ...
                        <div class="h-5"></div>
                        <span class="dis-block">({{{ $sell_rate ?? 0 }}})</span>
                        <div class="h-10"></div>
                        <div class="progress" dir="ltr">
                            <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="{{{ $sell_rate ?? 0 }}}"
                    ...
                    <div class="col-md-3 col-xs-12 col-sm-6 text-center">
                        ...
                        <div class="h-5"></div>
                        <span class="dis-block">({{{ $article_rate ?? 0 }}})</span>
                        <div class="h-10"></div>
                        <div class="progress" dir="ltr">
                            <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="{{{ $article_rate ?? 0 }}}"
                        ...
                        @foreach($videos as $vid)
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 tab-con">
                                    <a href="/product/{{{ $vid->id ?? '' }}}" title="{{{ $vid->title ?? '' }}}" class="content-box">
                                        ...
                                        <div class="footer">
                                            <label class="pull-right">{{{ $meta['duration'] ?? '0' }}} {{{ trans('main.min') }}}</label>
                ...
                <div class="body body-target-s">
                    <div class="row">
                        @foreach($channels as $ch)
                                <div class="col-md-3 col-sm-6 col-xs-12 tab-con">
                                    <a href="/chanel/{{{ $ch->username ?? '' }}}" title="{{{ $ch->title ?? '' }}}" class="content-box">
                                        <img src="{{{ $ch->avatar ?? '' }}}"/>
                            ...
                            <div class="ucp-section-box white-s">
                                ...
                                <div class="body body-target-s">
                                    <form method="post" action="/profile/request/store">
                                        <input type="hidden" name="user_id" value="{{{ $profile->id ?? 0 }}}">
