            ...
            <?php if(!empty($slider_container)): ?>
                <?php $__currentLoopData = $slider_container; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(isset($slide->content->metas)): ?>
                        ...
                        <div class="parts-container-slide" id="slide<?php echo e(isset($slide->content->id) ? $slide->content->id : 0); ?>">
                        <div class="header">
                            <span><?php echo e(trans('main.featured')); ?></span>
                            <h2><a href="/product/<?php echo e(isset($slide->content->id) ? $slide->content->id : 0); ?>"><?php echo e(isset($slide->content->title) ? $slide->content->title : ''); ?></a></h2>
                        </div>
                                ...
                                <div class="col-md-5 img-con-s">
                                    <div class="item-container">
                                        <div class="col-md-10 text-item">
                                            <span><?php echo e(isset($slide->description) ? $slide->description : ''); ?></span>
                                        </div>
                                        <div class="col-md-2">
                                    ...
                                    <div class="item-container">
                                        <div class="col-md-10 price-item profile-item">
                                            <label><a href="/profile/<?php echo e(isset($slide->content->user->id) ? $slide->content->user->id : 0); ?>" class="profile-s"><?php echo e(isset($slide->content->user->name) ? $slide->content->user->name : ''); ?></a></label>
                                        </div>
                                        <div class="col-md-2">
                                    ...
                                    <div>
                                        <a href="/product/<?php echo e(isset($slide->content->id) ? $slide->content->id : 0); ?>" class="btn btn-container-more btn-container-more-s"><?php echo e(trans('main.view_product')); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul class="container-bullet">
                        <?php if(!empty($slider_container)): ?>
                            <?php $__currentLoopData = $slider_container; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li data-target="slide<?php echo e(isset($slide->content->id) ? $slide->content->id : 0); ?>" <?php if($index == 0): ?> class="active" <?php endif; ?>></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </ul>
                </div>
