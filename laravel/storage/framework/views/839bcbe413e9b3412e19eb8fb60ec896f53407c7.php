                        ...
                        <?php $__currentLoopData = $new_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="owl-car-s" dir="rtl">
                                <a href="/product/<?php echo e(isset($new->id) ? $new->id : ''); ?>" title="<?php echo e(isset($new->title) ? $new->title : ''); ?>" class="content-box">
                                    ...
                                    <div class="footer">
                                        <span class="avatar" title="<?php echo e(isset($new->user->name) ? $new->user->name : ''); ?>" onclick="window.location.href = '/profile/<?php echo e(isset($new->user->id) ? $new->user->id : 0); ?>'"><img src="<?php echo e(get_user_meta($new->user_id,'avatar',get_option('default_user_avatar',''))); ?>"></span>
