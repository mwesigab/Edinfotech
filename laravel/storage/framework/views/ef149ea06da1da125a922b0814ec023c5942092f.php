                    ...
                    <div class="product-buy-selection">
                        <form>
                            ...
                            <?php if(!$buy): ?>
                                ...
                                <?php if($product->price != 0): ?><a class="btn btn-orange product-btn-buy sbox3" id="buy-btn" data-toggle="modal" data-target="#buyModal" href=""><?php echo e(trans('main.pay')); ?></a><?php endif; ?>
                            <?php else: ?>
                                <?php if($product->price != 0): ?><a class="btn btn-orange product-btn-buy sbox3" href="javascript:void(0);"><?php echo e(trans('main.purchased_item')); ?></a><?php endif; ?>
                            <?php endif; ?>
                            <?php endif; ?>
