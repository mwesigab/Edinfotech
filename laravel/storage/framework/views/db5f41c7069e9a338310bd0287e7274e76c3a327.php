                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_change_group" class="form-control">
                           ...
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_change_group']) && $temp->id == $_setting['notification_template_change_group']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_get_medal" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_get_medal']) && $temp->id == $_setting['notification_template_get_medal']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_delete_medal" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_delete_medal']) && $temp->id == $_setting['notification_template_delete_medal']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_content_pre_publish" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_content_pre_publish']) && $temp->id == $_setting['notification_template_content_pre_publish']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_content_publish" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_content_publish']) && $temp->id == $_setting['notification_template_content_publish']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_content_change" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_content_change']) && $temp->id == $_setting['notification_template_content_publish']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_content_delete" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_content_delete']) && $temp->id == $_setting['notification_template_content_delete']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_content_comment_new" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_content_comment_new']) && $temp->id == $_setting['notification_template_content_comment_new']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_content_support_new" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_content_support_new']) && $temp->id == $_setting['notification_template_content_support_new']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_request_get" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_request_get']) && $temp->id == $_setting['notification_template_request_get']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_request_publish" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_request_publish']) && $temp->id == $_setting['notification_template_request_publish']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_request_draft" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_request_draft']) && $temp->id == $_setting['notification_template_request_draft']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_request_req" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_request_req']) && $temp->id == $_setting['notification_template_request_req']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_request_follow" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_request_follow']) && $temp->id == $_setting['notification_template_request_follow']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_ticket_new" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_ticket_new']) && $temp->id == $_setting['notification_template_ticket_new']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_ticket_reply" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_ticket_reply']) && $temp->id == $_setting['notification_template_ticket_reply']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_withdraw_new" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_withdraw_new']) && $temp->id == $_setting['notification_template_withdraw_new']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_withdraw_pay" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_withdraw_pay']) && $temp->id == $_setting['notification_template_withdraw_pay']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_buy_new" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_buy_new']) && $temp->id == $_setting['notification_template_buy_new']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_sell_new" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_sell_new']) && $temp->id == $_setting['notification_template_sell_new']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_feedback_new" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_feedback_new']) && $temp->id == $_setting['notification_template_feedback_new']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-7">
                        <select id="template" name="notification_template_buy_post_withdraw" class="form-control">
                           <option value=""></option>
                           <?php $__currentLoopData = $template; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($temp->id); ?>" <?php if(isset($_setting['notification_template_buy_post_withdraw']) && $temp->id == $_setting['notification_template_buy_post_withdraw']): ?> selected <?php endif; ?>><?php echo e($temp->title); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </div>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Settings','Notifications']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>