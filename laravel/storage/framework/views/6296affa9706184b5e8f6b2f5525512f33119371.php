                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="input-group">
                            <input type="date" id="fsdate" class="text-center form-control" name="fsdate" value="<?php echo isset($_GET['fsdate']) ? $_GET['fsdate'] : ''; ?>" placeholder="Start Date">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            <input type="date" id="lsdate" class="text-center form-control" name="lsdate" value="<?php echo isset($_GET['lsdate']) ? $_GET['lsdate'] : ''; ?>" placeholder="End Date">
                            ...
                            <td class="text-center">
                                <?php if($item->users != null): ?>
                                    <?php $__currentLoopData = $item->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a title="<?php echo e(isset($u->user->name) ? $u->user->name : ''); ?>" href="/profile/<?php echo e(isset($u->user->id) ? $u->user->id : 0); ?>"><?php echo e(isset($u->user->username) ? $u->user->username : ''); ?></a>
                                        <br>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Support','Pending Tickets']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>