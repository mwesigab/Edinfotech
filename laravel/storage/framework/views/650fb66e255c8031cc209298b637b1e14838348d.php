                ...
                <tbody>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center" width="220"><?php if(is_numeric($user->create_at)): ?> <?php echo e(date('d F Y : H:i',$user->create_at)); ?> <?php endif; ?></td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Employees','List']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>