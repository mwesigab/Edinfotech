                ...
                <tbody>
                    <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center" title="<?php echo e(isset($item->user->username) ? $item->user->username : 'Automatic'); ?>" width="150"><?php echo e(isset($item->user->name) ? $item->user->name : 'Automatic'); ?></td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Notifications','Notifications List']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>