                ...
                <div class="col-md-5 col-xs-12 tab-con">
                    ...
                    <div class="btn-group soon-btngp ptopz" data-toggle="buttons">
                        ...
                        <label class="btn btn-primary <?php if(isset($_GET['mode']) && $_GET['mode']=='publish'): ?> active <?php endif; ?>">
                            <input type="radio" name="mode" value="publish" <?php if(isset($_GET['mode']) && $_GET['mode']=='publish'): ?> checked <?php endif; ?>><?php echo e(trans('main.soon')); ?>

                        </label>
                        <label class="btn btn-primary <?php if(isset($_GET['mode']) && $_GET['mode']=='accept'): ?> active <?php endif; ?>">
                            <input type="radio" name="mode" value="accept" <?php if(isset($_GET['mode']) && $_GET['mode']=='accept'): ?> checked <?php endif; ?>><?php echo e(trans('main.published')); ?>
                ...
                <div class="col-md-3 col-xs-12 text-left tab-con">
                    <div class="box marz">
                        <div class="container-2">
                            <form>
                                <input type="search" id="search" name="q" value="<?php echo e(isset($_GET['q']) ? $_GET['q'] : ''); ?>" placeholder="Search in coming soon courses" />
                            ...
                            <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4 col-sm-6 col-xs-12 pagi-content tab-con">
                                    <?php if($content->content_id != null): ?>
                                        <a href="/product/<?php echo e(isset($content->content_id) ? $content->content_id : 'javascript:void(0);'); ?>" title="<?php echo e(isset($content->title) ? $content->title : ''); ?>" class="content-box pagi-content-box">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                        <div class="img-container text-center center-block">
                                            <img src="<?php echo e(isset($content->image) ? $content->image : ''); ?>"/>
                                        </div>
                                        ...
                                        <div class="footer">
                                            ...
                                            <?php if($content->mode == 'publish'): ?>
                                                <?php if(count($content->fans)==1): ?>
                                                    ...
                                                    <span class="pull-left request-unfollow-icon" title="Unfollow" onclick="window.location.href ='/record/unfollow/<?php echo e(isset($content->id) ? $content->id : 0); ?>'"><?php echo e(isset($content->fans_count) ? $content->fans_count : 0); ?><?php echo e(trans('main.followers')); ?></span>
                                                <?php else: ?>
													<span class="boxicon mdi mdi-heart-outline pull-left"></span>
                                                    <span class="pull-left request-follow-icon" title="Follow" onclick="window.location.href ='/record/follow/<?php echo e(isset($content->id) ? $content->id : 0); ?>'"><?php echo e(isset($content->fans_count) ? $content->fans_count : 0); ?><?php echo e(trans('main.followers')); ?></span>
                                                <?php endif; ?>
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p><?php echo e(isset($content->description) ? $content->description : 'Description not found.'); ?></p>
                                                            </div>
