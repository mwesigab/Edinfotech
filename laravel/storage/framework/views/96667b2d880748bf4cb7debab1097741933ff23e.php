    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-bordered table-striped mb-none m-b-0" id="datatable-details">
                ...
                <tr>
                    <th class="text-center"><a target="_blank" href="/profile/<?php echo e($student->id); ?>"><?php echo e($student->student_name); ?></a></th>
                    ...
                    <th class="text-center">
                        <a href="/admin/user/item/<?php echo e($student->id); ?>" title="Edit"><i class="fa fa-edit"
                                                                                       aria-hidden="true"></i></a>
                        <a href="/admin/user/userlogin/<?php echo e($student->id); ?>" title="Login as user" target="_blank"><i
                                    class="fa fa-user" aria-hidden="true"></i></a>
                        <a href="#" data-href="/admin/user/delete/<?php echo e($student->id); ?>" title="Delete" data-toggle="modal"
