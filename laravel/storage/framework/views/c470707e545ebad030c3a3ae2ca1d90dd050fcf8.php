                        ...
                        <table class="table table-bordered table-striped mb-none" id="datatable-details">
                            ...
                            <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center"><a href="/admin/content/category/filter/<?php echo e(isset($list->id) ? $list->id : ''); ?>"><?php echo e(isset($list->filters_count) ? $list->filters_count : '0'); ?></a></td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Courses','Categories']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>