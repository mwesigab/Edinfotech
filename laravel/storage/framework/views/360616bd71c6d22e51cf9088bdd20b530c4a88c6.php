            ...
            <div class="tab-content">
                    <div id="request" class="tab-pane active">
                        <form method="post" action="/admin/setting/store" class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <textarea class="summernote" name="request_term" ><?php echo isset($_setting['request_term']) ? $_setting['request_term'] : ''; ?></textarea>
                                </div>
                            </div>
                    ...
                    <div id="term" class="tab-pane">
                        <form method="post" action="/admin/setting/store" class="form-horizontal form-bordered">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <textarea class="summernote" name="content_terms" required><?php echo e(isset($_setting['content_terms']) ? $_setting['content_terms'] : ''); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Settings','Rule & Terms']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>