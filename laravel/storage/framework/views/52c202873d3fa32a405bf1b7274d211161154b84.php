...
<div class="container-fluid">
    ...
    <input type="hidden" value="<?php echo e(isset($item->id) ? $item->id : 0); ?>" id="edit_id">
            ...
            <div class="col-md-3 col-xs-12 col-sm-4 tab-con right-side">
                <ul>
                    <li class="active" cstep="1"><a href="javascript:void(0);"><i
                                    class="upicon mdi mdi-library-video"></i><span><?php echo e(trans('main.general')); ?></span></a>
                    </li>
                    <li cstep="2"><a href="javascript:void(0);"><i class="upicon mdi mdi-apps"></i><span><?php echo e(trans('main.category')); ?></span></a>
                    </li>
                    <li cstep="3"><a href="javascript:void(0);"><i class="upicon mdi mdi-library-books"></i><span><?php echo e(trans('main.extra_info')); ?></span></a>
                    </li>
                    <li cstep="4"><a href="javascript:void(0);"><i class="upicon mdi mdi-folder-image"></i><span><?php echo e(trans('main.view')); ?></span></a>
                    </li>
                    <li cstep="5"><a href="javascript:void(0);"><i class="upicon mdi mdi-movie-open"></i><span><?php echo e(trans('main.parts')); ?></span></a>
                    </li>
                </ul>
            </div>
            <div class="col-md-9 col-xs-12 col-sm-8 tab-con left-side">
                <div class="steps" id="step1">
                    <form method="post" id="step-1-form" class="form-horizontal">
                            ...
                            <div class="col-md-10 tab-con">
                                <select name="type" class="form-control font-s">
                                    <option value="single" <?php if(isset($item) && $item->type == 'single'): ?> selected
                                        <?php endif; ?>><?php echo e(trans('main.single')); ?>

                                    </option>
                                    <option value="course" <?php if(isset($item) && $item->type == 'course'): ?> selected
                                        <?php endif; ?>><?php echo e(trans('main.course')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <select name="education_level" class="form-control font-s" id="education_level">
                                    ...
                                    <option value="1" <?php if(isset($item) && $item->education_level == '1'): ?> selected
                                        <?php endif; ?>><?php echo e(trans('main.education_level_one')); ?>

                                    </option>
                                    <option value="2" <?php if(isset($item) && $item->education_level == '2'): ?> selected
                                        <?php endif; ?>><?php echo e(trans('main.education_level_two')); ?>

                                    </option>
                                    <option value="3" <?php if(isset($item) && $item->education_level == '3'): ?> selected
                                        <?php endif; ?>><?php echo e(trans('main.education_level_three')); ?>

                                    </option>
                                </select>
                            </div>
                        </div>
                        <?php if(isset($item) && $item->education_level == '1'): ?>
                        <div class="form-group" id="primary_classes">
                            <label class="control-label col-md-2 tab-con" for="inputDefault"><?php echo e(trans('main.class')); ?></label>
                            <div class="col-md-10 tab-con">
                                <select name="study_class" class="form-control font-s">
                                    <option>Select--</option>
                                    <option value="7" <?php if($item->study_class == '7'): ?> selected <?php endif; ?>><?php echo e(trans('main.class_seven')); ?>

                                    </option>
                                    <option value="6" <?php if($item->study_class == '6'): ?> selected <?php endif; ?>><?php echo e(trans('main.class_six')); ?>

                                    </option>
                                    <option value="5" <?php if($item->study_class == '5'): ?> selected <?php endif; ?>><?php echo e(trans('main.class_five')); ?>

                                    </option>
                                    <option value="4" <?php if($item->study_class == '4'): ?> selected <?php endif; ?>><?php echo e(trans('main.class_four')); ?>

                                    </option>
                                    <option value="3" <?php if($item->study_class == '3'): ?> selected <?php endif; ?>><?php echo e(trans('main.class_three')); ?>

                                    </option>
                                    <option value="2" <?php if($item->study_class == '2'): ?> selected <?php endif; ?>><?php echo e(trans('main.class_two')); ?>

                                    </option>
                                    <option value="1" <?php if($item->study_class == '1'): ?> selected <?php endif; ?>><?php echo e(trans('main.class_one')); ?>

                                    </option>
                                    <option value="8" <?php if($item->study_class == '8'): ?> selected <?php endif; ?>><?php echo e(trans('main.elementary_three')); ?>

                                    </option>
                                    <option value="9" <?php if($item->study_class == '9'): ?> selected <?php endif; ?>><?php echo e(trans('main.elementary_two')); ?>

                                    </option>
                                    <option value="10" <?php if($item->study_class == '10'): ?> selected <?php endif; ?>><?php echo e(trans('main.elementary_one')); ?>
                        ...
                        <?php endif; ?>
                        <?php if(isset($item) && $item->education_level == '2'): ?>
                        <div class="form-group" id="secondary_classes">
                            <label class="control-label col-md-2 tab-con" for="inputDefault"><?php echo e(trans('main.class')); ?></label>
                            <div class="col-md-10 tab-con">
                                <select name="study_class" class="form-control font-s">
                                    <option>Select--</option>
                                    <option value="6" <?php if($item->study_class == '6'): ?> selected <?php endif; ?>><?php echo e(trans('main.senior_six')); ?>

                                    </option>
                                    <option value="5" <?php if($item->study_class == '5'): ?> selected <?php endif; ?>><?php echo e(trans('main.senior_five')); ?>

                                    </option>
                                    <option value="4" <?php if($item->study_class == '4'): ?> selected <?php endif; ?>><?php echo e(trans('main.senior_four')); ?>

                                    </option>
                                    <option value="3" <?php if($item->study_class == '3'): ?> selected <?php endif; ?>><?php echo e(trans('main.senior_three')); ?>

                                    </option>
                                    <option value="2" <?php if($item->study_class == '2'): ?> selected <?php endif; ?>><?php echo e(trans('main.senior_two')); ?>

                                    </option>
                                    <option value="1" <?php if($item->study_class == '1'): ?> selected <?php endif; ?>><?php echo e(trans('main.senior_one')); ?>
                        ...
                        <?php if(isset($item) && $item->education_level == '3'): ?>
                        <div class="form-group" id="university_classes">
                            <label class="control-label col-md-2 tab-con" for="inputDefault"><?php echo e(trans('main.class')); ?></label>
                            <div class="col-md-10 tab-con">
                                <select name="study_class" class="form-control font-s">
                                    <option>Select--</option>
                                    <option value="6" <?php if($item->study_class == '6'): ?> selected <?php endif; ?>><?php echo e(trans('main.sixth_year')); ?>

                                    </option>
                                    <option value="5" <?php if($item->study_class == '5'): ?> selected <?php endif; ?>><?php echo e(trans('main.fifth_year')); ?>

                                    </option>
                                    <option value="4" <?php if($item->study_class == '4'): ?> selected <?php endif; ?>><?php echo e(trans('main.fourth_year')); ?>

                                    </option>
                                    <option value="3" <?php if($item->study_class == '3'): ?> selected <?php endif; ?>><?php echo e(trans('main.third_year')); ?>

                                    </option>
                                    <option value="2" <?php if($item->study_class == '2'): ?> selected <?php endif; ?>><?php echo e(trans('main.second_year')); ?>

                                    </option>
                                    <option value="1" <?php if($item->study_class == '1'): ?> selected <?php endif; ?>><?php echo e(trans('main.first_year')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <input type="text" name="title" placeholder="Course Title..." class="form-control"
                                       value="<?php echo e(isset($item->title) ? $item->title : ''); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <textarea class="form-control editor-te editor-te-h"
                                          placeholder="You can import HTML..." name="content" required><?php echo isset($item->content) ? $item->content : ''; ?></textarea>
                            </div>
                        </div>
                    </form>
                ...
                <div class="steps dnone" id="step2">
                    <form method="post" id="step-2-form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <input type="text" data-role="tagsinput" placeholder="Press enter to save tag."
                                       name="tag" value="<?php echo e(isset($item->tag) ? $item->tag : ''); ?>" class="form-control text-center">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10 tab-con">
                                <select name="category_id" id="category_id" class="form-control font-s" required>
                                    ...
                                    <optgroup label="<?php echo e(isset($menu->title) ? $menu->title : ''); ?>">
                                        ...
                                        <option value="<?php echo e(isset($sub->id) ? $sub->id : ''); ?>" <?php if($sub->id == $item->category_id): ?>
                                            selected <?php endif; ?>><?php echo e(isset($sub->title) ? $sub->title : ''); ?>

                                        </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                        <option value="<?php echo e(isset($menu->id) ? $menu->id : ''); ?>" <?php if($menu->id == $item->category_id): ?>
                                            selected <?php endif; ?>><?php echo e(isset($menu->title) ? $menu->title : ''); ?>
                        ...
                        <div class="col-md-11 col-md-offset-1 tab-con filters dnone" <?php if($menu->id !=
                            $item->category_id): ?> class="dnone" <?php endif; ?> id="filter<?php echo e(isset($menu->id) ? $menu->id : 0); ?>">
                                ...
                                <ul class="cat-filters-li pamaz">
                                    <ul class="submenu submenu-s">
                                        ...
                                        <li class="second-input"><input type="checkbox" class="filter-tags dblock"
                                                                        id="tag<?php echo e(isset($tag->id) ? $tag->id : ''); ?>" name="filters[]"
                                                                        value="<?php echo e(isset($tag->id) ? $tag->id : 0); ?>" <?php if(isset($item->filters)
                                            && in_array($tag->id,$item->filters->pluck('id')->toArray())): ?> checked
                                            <?php endif; ?>><label for="tag<?php echo e(isset($tag->id) ? $tag->id : ''); ?>"><span></span><?php echo e(isset($tag->tag) ? $tag->tag : ''); ?></label></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </ul>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 tab-con">
                                <div class="switch switch-sm switch-primary pull-left">
                                    ...
                                    <input type="checkbox" name="support" value="1" data-plugin-ios-switch <?php if($item->support
                                    == 1): ?> checked="checked" <?php endif; ?> />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 tab-con">
                                <div class="switch switch-sm switch-primary pull-left">
                                    ...
                                    <input type="checkbox" name="download" value="1" data-plugin-ios-switch <?php if($item->download
                                    == 1): ?> checked="checked" <?php endif; ?> />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price" onkeypress="validate(event)"
                                           value="<?php echo e(isset($meta['price']) ? $meta['price'] : ''); ?>" class="form-control text-center numtostr"
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="post_price" onkeypress="validate(event)"
                                           value="<?php echo e(isset($meta['post_price']) ? $meta['post_price'] : ''); ?>"
                                           class="form-control text-center numtostr" <?php if($item->post != 1): ?> disabled
                                    <?php endif; ?>>
                                    <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price_3" onkeypress="validate(event)"
                                           value="<?php echo e(isset($item->price_3) ? $item->price_3 : ''); ?>" class="form-control text-center">
                                    <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price_6" onkeypress="validate(event)"
                                           value="<?php echo e(isset($item->price_6) ? $item->price_6 : ''); ?>" class="form-control text-center">
                                    <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price_9" onkeypress="validate(event)"
                                           value="<?php echo e(isset($item->price_9) ? $item->price_9 : ''); ?>" class="form-control text-center">
                                    <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 tab-con">
                                <div class="input-group">
                                    <input type="number" name="price_12" onkeypress="validate(event)"
                                           value="<?php echo e(isset($item->price_12) ? $item->price_12 : ''); ?>" class="form-control text-center">
                                    <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body no-absolute-content">
                                    <form method="post" id="step-3-form-precourse">
                                        <input type="hidden" name="precourse" id="precourse"
                                               value="<?php echo e(isset($meta['precourse']) ? $meta['precourse'] : ''); ?>">
                                    </form>
                                    <ul class="pre-course-title-container">
                                        ...
                                        <li><?php echo e(isset($prec->title) ? $prec->title : ''); ?>&nbsp;(VT-<?php echo e(isset($prec->id) ? $prec->id : 0); ?>)<i
                                                    class="fa fa-times delete-course" cid="<?php echo e(isset($prec->id) ? $prec->id : 0); ?>"></i>
                                        </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-custom pull-left" data-dismiss="modal"><?php echo e(trans('main.close')); ?>
                            ...
                            <div class="col-md-10 tab-con">
                                <div class="input-group">
                                    <span class="input-group-addon view-selected img-icon-s" data-toggle="modal"
                                          data-target="#ImageModal" data-whatever="cover" "><span
                                            class="formicon mdi mdi-eye"></span></span>
                                    <input type="text" name="cover" placeholder="Prefered :410*730px" dir="ltr"
                                           value="<?php echo e(isset($meta['cover']) ? $meta['cover'] : ''); ?>" class="form-control">
                            ...
                            <div class="col-md-10 tab-con">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="thumbnail" placeholder="Prefered :155*263px" dir="ltr"
                                           value="<?php echo e(isset($meta['thumbnail']) ? $meta['thumbnail'] : ''); ?>" class="form-control">
                                    <span class="input-group-addon click-for-upload img-icon-s"><span
                                                class="formicon mdi mdi-arrow-up-thick"></span></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10 tab-con">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="video" placeholder="Prefered :1-3 mins" dir="ltr"
                                           value="<?php echo e(isset($meta['video']) ? $meta['video'] : ''); ?>" class="form-control">
                                    <span class="input-group-addon click-for-upload img-icon-s"><span
                                                class="formicon mdi mdi-arrow-up-thick"></span></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10 tab-con">
                                <div class="input-group document-input">
                                    ...
                                    <input type="text" name="document" id="document-addon" dir="ltr"
                                           value="<?php echo e(isset($meta['document']) ? $meta['document'] : ''); ?>" class="form-control">
                    ...
                    <div class="accordion-off">
                        <ul id="accordion" class="accordion off-filters-li">
                            <li class="open edit-part-section dnone">
                                <div class="link edit-part-click"><h2><?php echo e(trans('main.edit_part')); ?></h2><i
                                ...
                                <div class="submenu dblock">
                                    ...
                                    <form action="/user/content/part/edit/store/" id="step-5-form-edit-part"
                                        ...
                                        <input type="hidden" name="content_id" value="<?php echo e(isset($item->id) ? $item->id : ''); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7 tab-con">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon click-for-upload img-icon-s"><span
                                                                class="formicon mdi mdi-arrow-up-thick"></span></span>
                                                    <span class="input-group-addon click-for-vimeo img-icon-s"><span
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 tab-con">
                                                <button class="btn btn-custom pull-left" id="edit-part-submit"
                                                        type="submit"><?php echo e(trans('main.edit_part')); ?>
                            ...
                            <li class="open">
                                <div class="link new-part-click"><h2><?php echo e(trans('main.new_part')); ?></h2><i
                                            class="mdi mdi-chevron-down"></i></div>
                                <div class="submenu dblock">
                                    <div class="h-15"></div>
                                            ...
                                            <div class="col-md-7 tab-con">
                                                <div class="input-group">
                                                    ...
                                                    <span data-toggle="modal" href="#vimeo-modal"
                                                          ...
                                                          title="remote upload from vimeo"><span
                                                                class="formicon mdi mdi-vimeo"></span></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 tab-con">
                                                <button class="btn btn-custom tab-con pull-left" id="new-part"
                                                        type="submit"><?php echo e(trans('main.save_changes')); ?>
                            ...
                            <li>
                                <div class="link list-part-click"><h2><?php echo e(trans('main.parts')); ?></h2><i
                                            class="mdi mdi-chevron-down"></i></div>
                                <div class="submenu">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon click-to-upload-vimeo" style="cursor: pointer;"><label
                                    class="mdi mdi-download img-icon-s"
                                    style="position: relative;top: 6px;"></label></span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-custom pull-left" id="delete-request"><?php echo e(trans('main.yes_sure')); ?>
...
<script>
    ...
    $('#draft-btn').click(function () {
        var id = $('#edit_id').val();
        $.post('/school/content/edit/store/' + id, $('#step-1-form').serialize());
        ...
        $.post('/school/content/edit/store/' + id, $('#step-3-form-subscribe').serialize());
    ...
    function ajaxPostOrGetCall(url_string, http_method, postValue) {
        $.ajax({
            url: url_string,
            method: http_method,
            data: {
    ...
    $('.btn-publish-final').click(function () {
        var id = $('#edit_id').val();
        /*ajaxPostOrGetCall('/school/content/edit/meta/store/' + id,'post',$('#step-1-form-meta').serialize());
        ajaxPostOrGetCall('/school/content/edit/store/' + id,'post',$('#step-2-form').serialize());
        ajaxPostOrGetCall('/school/content/edit/store/' + id,'post',$('#step-3-form').serialize());
        ajaxPostOrGetCall('/school/content/edit/meta/store/' + id,'post',$('#step-3-form-meta').serialize());
