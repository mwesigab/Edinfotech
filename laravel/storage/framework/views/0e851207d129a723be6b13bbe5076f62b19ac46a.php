            ...
            <div class="accordion-off col-xs-12">
                <ul id="accordion" class="accordion off-filters-li">
                    <?php $__currentLoopData = $supports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li <?php if(isset($_GET['openid']) && $content->id == $_GET['openid']): ?> class="open" <?php endif; ?>>
                            <div class="link"><h2><?php echo e(isset($content->title) ? $content->title : ''); ?> (<?php echo e(count($content->supports->groupBy('sender_id'))); ?>)</h2><i class="mdi mdi-chevron-down"></i></div>
                            <ul class="submenu" <?php if(isset($_GET['openid']) && $content->id == $_GET['openid']): ?> style="display: block;" <?php endif; ?>>
                                ...
                                <table class="table ucp-table" id="suport-table">
                                    ...
                                    <?php if($content->supports->count()>0): ?>
                                        <?php $__currentLoopData = listByKey($content->supports->toArray(),'sender_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                            <td><?php echo e(isset($support[0]['sender']['name']) ? $support[0]['sender']['name'] : $support[0]['sender']['username']); ?></td>
                                            <?php if(isset($support['child']) && count($support['child'])>0): ?>
                                            ...
                                            <?php endif; ?>
                                            <td class="text-center"><?php echo e(date('d F Y | H:i',$support[0]['create_at'])); ?></td>
                                            <td class="text-center">
                                                <a href="javascript:void(0)" class="replyBtn" data-toggle="modal" data-target="#answerBox" sender-id="<?php echo e(isset($support[0]['sender']['id']) ? $support[0]['sender']['id'] : 0); ?>" content-id="<?php echo e(isset($content->id) ? $content->id : 0); ?>" title="View/Reply"><i class="fa fa-comment" aria-hidden="true"></i></a>
                                            </td>
                                            </tr>
