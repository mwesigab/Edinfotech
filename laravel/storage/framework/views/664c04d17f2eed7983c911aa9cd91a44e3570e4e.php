                        ...
                        <div class="body">
                            <ul>
                                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><input type="checkbox" name="category" id="category<?php echo e(isset($cat->id) ? $cat->id : ''); ?>" value="<?php echo e(isset($cat->id) ? $cat->id : ''); ?>" <?php if(isset($cats) && in_array($cat->id,$cats)): ?> checked <?php endif; ?>/><label for="category<?php echo e(isset($cat->id) ? $cat->id : ''); ?>"><span></span><?php echo e(isset($cat->title) ? $cat->title : ''); ?></label></li>
                            ...
                            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4 col-xs-12 article-post-count tab-con">
                                    <div class="post-module">
                                        <div class="thumbnail">
                                            <div class="date">
                                                <div class="day"><?php echo e(date('d',$post->create_at)); ?></div>
                                                <div class="month"><?php echo e(date('F',$post->create_at)); ?></div>
                                            </div>
                                            <img src="<?php echo e(isset($post->image) ? $post->image : ''); ?>">
                                        </div>
                                        <div class="post-content">
                                            <h1 class="title"><a href="/article/item/<?php echo e($post->id); ?>"><h3><?php echo e(isset($post->title) ? $post->title : ''); ?></h3></a></h1>
                                            <p class="description">
...
<?php $__env->startSection('script'); ?>
    <script>
        $(function() {
            pagination('.blog-section',<?php echo e(isset($setting['site']['article_post_count']) ? $setting['site']['article_post_count'] : 6); ?>,0);
        $('.pagi').pagination({
            items: <?php echo count($posts); ?>,
            itemsOnPage:<?php echo e(isset($setting['site']['article_post_count']) ? $setting['site']['article_post_count'] : 6); ?>,
            cssStyle: 'light-theme',
            prevText: 'Pre.',
            nextText:'Next',
            onPageClick:function(pageNumber, event) {
            pagination('.blog-section',<?php echo e(isset($setting['site']['article_post_count']) ? $setting['site']['article_post_count'] : 6); ?>,pageNumber-1);
        }
        });
        });
    </script>
