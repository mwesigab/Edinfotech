                ...
                <tbody>
                    <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a target="_blank" href="/profile/<?php echo e(isset($item->user->id) ? $item->user->id : 0); ?>"><?php echo e(isset($item->user->name) ? $item->user->name : ''); ?></a></td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Courses','Comments']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>