                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <label class="custom-switch">
                                        ...
                                        <input type="checkbox" name="price" id="free_course" value="0" class="custom-switch-input" <?php if($item->price == 0): ?> <?php echo e('checked="checked"'); ?> <?php endif; ?> />
                                        <span class="custom-switch-indicator"></span>
                    ...
                    <div id="meta" class="tab-pane ">
                        <form action="/admin/content/store/<?php echo e($item->id); ?>/meta" class="form-horizontal form-bordered" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <input type="text" name="price" value="<?php echo e(isset($meta['price']) ? $meta['price'] : ''); ?>" class="form-control text-center" id="product_price" <?php if($item->price == 0): ?> disabled="disabled" <?php endif; ?>>
                                        <span class="input-group-append click-for-upload cu-p" >
                            ...
                            <?php if(!empty($filters)): ?>
                                <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-3 col-xs-12">
                                        <fieldset>
                                            <legend class="custom-legend" style="font-weight: bold;"><?php echo e(isset($filter->filter) ? $filter->filter : ''); ?></legend>
                                            <?php $__currentLoopData = $filter->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                &nbsp;&nbsp;&nbsp;<input type="checkbox" value="<?php echo e($tag->id); ?>" name="tags[]" style="position: relative;top: 2px;" <?php echo e(checkedInObject($tag->id,'tag_id',$item->tags)); ?>>&nbsp;<?php echo e(isset($tag->tag) ? $tag->tag : ''); ?><br>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </fieldset>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div id="parts" class="tab-pane ">
                        <table class="table table-bordered table-striped mb-none" id="datatable-details">
                            ...
                            <?php $__currentLoopData = $item->parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e(isset($part->title) ? $part->title : ''); ?>&nbsp;<?php if($part->free == 1 || $item->price == 0): ?>(Free)<?php endif; ?></td>
                                    ...
                                    <td class="text-center"><?php echo e(isset($part->size) ? $part->size : '0'); ?></td>
                                    <td class="text-center"><?php echo e(isset($part->duration) ? $part->duration : '0'); ?></td>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" name="price_3" value="<?php echo e(isset($item->price_3) ? $item->price_3 : ''); ?>" class="form-control text-center">
                                                <span class="input-group-append click-for-upload cu-p">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="subscribe_3" value="<?php echo e(isset($item->subscribe_3) ? $item->subscribe_3 : ''); ?>" class="form-control text-center">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" name="price_6" value="<?php echo e(isset($item->price_6) ? $item->price_6 : ''); ?>" class="form-control text-center">
                                                <span class="input-group-append click-for-upload cu-p">
                                    <span class="input-group-text"><?php echo e(currencySign()); ?></span>
                                </span>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <label class="col-md-12 control-label">PayPal Product Code</label>
                                        <div class="col-md-12">
                                            <input type="text" name="subscribe_6" value="<?php echo e(isset($item->subscribe_6) ? $item->subscribe_6 : ''); ?>" class="form-control text-center">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" name="price_9" value="<?php echo e(isset($item->price_9) ? $item->price_9 : ''); ?>" class="form-control text-center">
                                                <span class="input-group-append click-for-upload cu-p">
                                    <span class="input-group-text"><?php echo e(currencySign()); ?></span>
                                </span>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <label class="col-md-12 control-label">PayPal Product Code</label>
                                        <div class="col-md-12">
                                            <input type="text" name="subscribe_9" value="<?php echo e(isset($item->subscribe_9) ? $item->subscribe_9 : ''); ?>" class="form-control text-center">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input type="text" name="price_12" value="<?php echo e(isset($item->price_12) ? $item->price_12 : ''); ?>" class="form-control text-center">
                                                <span class="input-group-append click-for-upload cu-p">
                                    <span class="input-group-text"><?php echo e(currencySign()); ?></span>
                                </span>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <label class="col-md-12 control-label">PayPal Product Code</label>
                                        <div class="col-md-12">
                                            <input type="text" name="subscribe_12" value="<?php echo e(isset($item->subscribe_12) ? $item->subscribe_12 : ''); ?>" class="form-control text-center">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Courses','Edit',$item->title]], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>