                ...
                <table class="table table-bordered table-striped mb-none" style="margin-bottom: 0;" id="datatable-details">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <th class="text-center number-green" width="100" <?php if($user->income<0): ?> style="color:red !important;" <?php endif; ?> dir="ltr"><?php echo e(isset($user->income) ? $user->income : 0); ?></th>
                            <th class="text-center number-green" width="100" <?php if($user->credit<0): ?> style="color:red !important;" <?php endif; ?> dir="ltr"><?php echo e(isset($user->credit) ? $user->credit : 0); ?></th>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Users','Identity Verification','Admin Panel']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>