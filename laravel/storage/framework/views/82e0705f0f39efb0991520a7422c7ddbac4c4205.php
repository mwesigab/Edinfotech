         ...
         <div class="tab-content">
               <div id="css" class="tab-pane active">
                  <form method="post" action="/admin/setting/store" class="form-horizontal form-bordered">
                     ...
                     <div class="form-group">
                        <div class="col-md-12">
                           <textarea class="form-control text-left h-400" style="height: 400px !important;" dir="ltr" name="main_css" ><?php echo isset($_setting['main_css']) ? $_setting['main_css'] : ''; ?></textarea>
                        </div>
                     </div>
               ...
               <div id="js" class="tab-pane">
                  <form method="post" action="/admin/setting/store" class="form-horizontal form-bordered">
                     ...
                     <div class="form-group">
                        <div class="col-md-12">
                           <textarea class="form-control text-left h-400" style="height: 400px !important;" dir="ltr" name="main_js" ><?php echo isset($_setting['main_js']) ? $_setting['main_js'] : ''; ?></textarea>
                        </div>
                     </div>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Settings','Custom CSS & JS']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>