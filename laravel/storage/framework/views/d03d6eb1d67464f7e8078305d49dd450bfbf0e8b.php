         ...
         <div class="tab-content">
            <div id="terms" class="tab-pane active">
               <form method="post" action="/admin/setting/store" class="form-horizontal form-bordered">
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <textarea class="summernote" name="pages_terms" ><?php echo isset($_setting['pages_terms']) ? $_setting['pages_terms'] : ''; ?></textarea>
                     </div>
                  </div>
            ...
            <div id="contact" class="tab-pane fade">
               <form method="post" action="/admin/setting/store/contact" class="form-horizontal form-bordered">
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <textarea class="summernote" name="pages_contact" ><?php echo isset($_setting['pages_contact']) ? $_setting['pages_contact'] : ''; ?></textarea>
                     </div>
                  </div>
            ...
            <div id="about" class="tab-pane fade">
               <form method="post" action="/admin/setting/store/about" class="form-horizontal form-bordered">
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <textarea class="summernote" name="pages_about" ><?php echo isset($_setting['pages_about']) ? $_setting['pages_about'] : ''; ?></textarea>
                     </div>
                  </div>
            ...
            <div id="help" class="tab-pane fade">
               <form method="post" action="/admin/setting/store/help" class="form-horizontal form-bordered">
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <textarea class="summernote" name="pages_help"><?php echo isset($_setting['pages_help']) ? $_setting['pages_help'] : ''; ?></textarea>
                     </div>
                  </div>
            ...
            <div id="update" class="tab-pane fade">
               <form method="post" action="/admin/setting/store/update" class="form-horizontal form-bordered">
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <textarea class="summernote" name="pages_content_update"><?php echo isset($_setting['pages_content_update']) ? $_setting['pages_content_update'] : ''; ?></textarea>
                     </div>
                  </div>
            ...
            <div id="delete" class="tab-pane fade">
               <form method="post" action="/admin/setting/store/delete" class="form-horizontal form-bordered">
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <textarea class="summernote" name="pages_content_delete"><?php echo isset($_setting['pages_content_delete']) ? $_setting['pages_content_delete'] : ''; ?></textarea>
                     </div>
                  </div>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Settings','Pages']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>