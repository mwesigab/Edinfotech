                    ...
                    <div class="widget-summary">
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <div class="info">
                                    <strong class="amount"><?php echo e(isset($allIncome) ? $allIncome : 0); ?></strong>
                                </div>
                            </div>
                            <div class="summary-footer">
                    ...
                    <div class="widget-summary">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <div class="info">
                                    <strong class="amount"><?php echo e(isset($sellCount) ? $sellCount : 0); ?></strong>
                                </div>
                            </div>
                            <div class="summary-footer">
                                <a href="/admin/buysell/list" class="text text-uppercase"><?php echo e(trans('admin.sales_list')); ?></a>
                    ...
                    <div class="widget-summary">
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <div class="info">
                                    <strong class="amount"><?php echo e(isset($transactionCount) ? $transactionCount : 0); ?></strong>
                                </div>
                            </div>
                            <div class="summary-footer">
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Reports','Financial']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>