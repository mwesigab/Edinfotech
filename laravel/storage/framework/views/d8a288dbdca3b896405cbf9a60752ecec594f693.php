                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="input-group">
                            <input type="date" value="<?php echo $_GET['fsdate'] ?? ''; ?>" id="fsdate" class="text-center form-control" name="fsdate" placeholder="Start Date">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            <input type="date" value="<?php echo $_GET['lsdate'] ?? ''; ?>" id="lsdate" class="text-center form-control" name="lsdate" placeholder="End Date">
                            <input type="hidden" id="ldate" name="ldate" value="<?php echo $_GET['ldate'] ?? ''; ?>">
                            <span class="input-group-append fdatebtn" id="fdatebtn">
                                <span class="input-group-text"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                            </span>
                        </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <input type="text" class="form-control text-center" name="id" value="<?php echo $_GET['id'] ?? ''; ?>" placeholder="Item Code">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Courses','Latest Courses']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PRACTICE SESSIONS\PHP\Edtech\laravel\resources\views/admin/content/waiting.blade.php ENDPATH**/ ?>