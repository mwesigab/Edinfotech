...
<?php $__env->startSection('tab'); ?>
    <div class="h-20"></div>
    <div class="h-10"></div>
    <form method="post" action="/user/article/edit/store/<?php echo e(isset($article->id) ? $article->id : 0); ?>" class="form-horizontal">
        <div class="form-group">
            <label class="control-label col-md-1 tab-con"><?php echo e(trans('main.title')); ?></label>
            <div class="col-md-6 tab-con">
                <input type="text" value="<?php echo e(isset($article->title) ? $article->title : ''); ?>" class="form-control" name="title">
            </div>
            ...
            <div class="col-md-4 tab-con">
                <select class="form-control font-s" name="cat_id">
                    <?php $__currentLoopData = contentMenu(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <optgroup label="<?php echo e(isset($menu['title']) ? $menu['title'] : ''); ?>&nbsp;11<?php echo e(count($menu['submenu'])); ?>">
                            <?php if(count($menu['submenu']) == 0): ?>
                                <option value="<?php echo e(isset($menu['id']) ? $menu['id'] : ''); ?>" <?php if($menu['id'] == $article->cat_id): ?> selected <?php endif; ?>><?php echo e(isset($menu['title']) ? $menu['title'] : ''); ?></option>
                            <?php else: ?>
                                <?php $__currentLoopData = $menu['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(isset($sub['id']) ? $sub['id'] : ''); ?>" <?php if($sub['id'] == $article->cat_id): ?> selected <?php endif; ?>><?php echo e(isset($sub['title']) ? $sub['title'] : ''); ?></option>
        ...
        <div class="form-group">
            ...
            <div class="col-md-11 tab-con">
                <textarea class="ckeditor" name="pre_text"><?php echo e(isset($article->pre_text) ? $article->pre_text : ''); ?></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-1 tab-con"><?php echo e(trans('main.description')); ?></label>
            <div class="col-md-11 tab-con">
                <textarea class="ckeditor" name="text"><?php echo e(isset($article->text) ? $article->text : ''); ?></textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-5 tab-con">
                <div class="input-group">
                    ...
                    <input type="text" name="image" value="<?php echo e(isset($article->image) ? $article->image : ''); ?>" dir="ltr" class="form-control">
...
<script>$('#newarticle').text('<?php echo e(isset($article->title) ? $article->title : ''); ?>')</script>
...
<?php echo $__env->make('user.layout.articlelayout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>