    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="row middle-header">
            <div class="col-md-3 col-xs-12 tab-con">
                <div class="row">
                    <a href="/">
                        <img src="<?php echo e(get_option('site_logo')); ?>" alt="<?php echo e(get_option('site_title')); ?>"
                             class="logo-icon"/>
                        <img src="<?php echo e(get_option('site_logo_type')); ?>" alt="<?php echo e(get_option('site_title')); ?>"
                             class="logo-type"/>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-12 text-center tab-con">
                <div class="row">
                    ...
                    <a href="/user/content/new" class="header-upload-button pulse"><span
                                class="headericon mdi mdi-arrow-up-bold"></span><?php echo e(trans('main.upload_course')); ?></a>
                    <?php endif; ?>
                    <?php if(isset($user)): ?>
                    <a href="/user" class="header-login-in-button">
                        <img src="<?php echo e($userMeta['avatar'] ?? get_option('default_user_avatar','')); ?>"
                        ...
                        <div class="animated user-overlap sbox3">
                            <div class="overlap-profile-viewer">
                                ...
                                <a href="/user/dashboard"><img
                                            src="<?php echo e($userMeta['avatar'] ?? '/assets/images/user.png'); ?>"
                                            class="dash-s"></a>
                                <?php else: ?>
                            ...
                            <ul>
                                <li><a href="/profile/<?php echo e($user['id'] ?? 0); ?>"><span
                    ...
                    <a href="/user" class="header-login-in-button">
                        ...
                        <div class="animated user-overlap sbox3">
                            ...
                            <ul>
                                <li><a href="/school/student/profile/<?php echo e($student['id'] ?? 0); ?>"><span
                                                class="headericon mdi mdi-account"></span>
                                        <p><?php echo e(trans('main.profile')); ?></p></a></li>
            ...
            <div class="menu-header">
                ...
                <div class="col-md-10 col-xs-12 tab-con">
                    <ul id="accordion" class="cat-filters-li accordion accordion-s">
                        ...
                        <li class="has-child" onmouseover="this.style.borderColor='<?php echo e($mainCategory->color ?? ''); ?>'"
                            onmouseleave="this.style.borderColor='transparent'"><a href="javascript:void(0);"><img
                                        src="<?php echo e($mainCategory->image ?? ''); ?>"/><?php echo e($mainCategory->title ?? ''); ?></a>
                            <ul>
                                ...
                                <li onmouseover="this.style.borderColor='<?php echo e($child->color ?? ''); ?>'"
                                    onmouseleave="this.style.borderColor='transparent'"><a
                                            href="/category/<?php echo e($child->class); ?>"><img
                                                src="<?php echo e($child->image ?? ''); ?>"/><?php echo e($child->title ?? ''); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </li>
                        <?php else: ?>
                        <li class="no-child" onmouseover="this.style.borderColor='<?php echo e($mainCategory->color ?? ''); ?>'"
                            onmouseleave="this.style.borderColor='transparent'"><a
                                    href="/category/<?php echo e($mainCategory->class); ?>"><img
                                        src="<?php echo e($mainCategory->image ?? ''); ?>"/><?php echo e($mainCategory->title ?? ''); ?></a>
                        </li>
                        <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true" aria-expanded="false"><?php echo e($mainCategory->title ?? ''); ?><span
                                        class="caret"></span></a>
