                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select name="buyer" data-plugin-selectTwo class="form-control populate">
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(isset($user->id) ? $user->id : 0); ?>" <?php if(isset($_GET['buyer']) && $_GET['buyer']==$user->id): ?> selected <?php endif; ?>><?php echo e(isset($user->name) ? $user->name : $user->username); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <select name="content" data-plugin-selectTwo class="form-control populate">
                                ...
                                <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(isset($content->id) ? $content->id : 0); ?>" <?php if(isset($_GET['content']) && $_GET['content']==$content->id): ?> selected <?php endif; ?>><?php echo e(isset($content->title) ? $content->title : ''); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <select name="type" class="form-control">
                                ...
                                <option value="download" <?php if(isset($_GET['type']) && $_GET['type']=='download'): ?> selected <?php endif; ?>><?php echo e(trans('admin.download')); ?></option>
                                <option value="post" <?php if(isset($_GET['type']) && $_GET['type']=='post'): ?> selected <?php endif; ?>><?php echo e(trans('admin.postal')); ?></option>
                                <option value="success" <?php if(isset($_GET['type']) && $_GET['type']=='success'): ?> selected <?php endif; ?>><?php echo e(trans('admin.postal_successful')); ?></option>
                                <option value="fail" <?php if(isset($_GET['type']) && $_GET['type']=='fail'): ?> selected <?php endif; ?>><?php echo e(trans('admin.postal_failed')); ?></option>
                                <option value="wait" <?php if(isset($_GET['type']) && $_GET['type']=='wait'): ?> selected <?php endif; ?>><?php echo e(trans('admin.postal_waiting')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-details">
                ...
                <tbody>
                    <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><a href="/product/<?php echo e(isset($item->content->id) ? $item->content->id : 0); ?>"><?php echo e(isset($item->content->title) ? $item->content->title : ''); ?></a></td>
                            <td class="text-center" title="<?php echo e(isset($item->user->name) ? $item->user->name : ''); ?>"><a href="/profile/<?php echo e(isset($item->user->id) ? $item->user->id : 0); ?>"><?php echo e(isset($item->user->username) ? $item->user->username : ''); ?></a></td>
                            <td class="text-center" title="<?php echo e(isset($item->buyer->name) ? $item->buyer->name : ''); ?>"><a href="/profile/<?php echo e(isset($item->buyer->id) ? $item->buyer->id : 0); ?>"><?php echo e(isset($item->buyer->username) ? $item->buyer->username : ''); ?></a></td>
                            <td class="text-center"><?php echo e(isset($item->transaction->price) ? $item->transaction->price : 0); ?> <?php echo e(trans('admin.cur_dollar')); ?></td>
                            ...
                            <td class="text-center">
                                ...
                                <?php else: ?>
                                    <b class="c-b" title="Shipping Tracing Code <?php echo e(isset($item->post_code) ? $item->post_code : ''); ?>"><?php echo e(trans('admin.postal')); ?></b>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if($item->mode == 'pay'): ?>
                                    ...
                                    <?php else: ?>
                                        <?php if($item->post_feedback == 1): ?>
                                            <b class="c-g"><?php echo e(trans('admin.paid_successful')); ?></b>
                                        <?php elseif($item->post_feedback == 2 && $item->post_feedback == 2): ?>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Sales','Sales List']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>