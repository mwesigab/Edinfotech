            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped mb-none" id="datatable-details">
                    ...
                    <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="cu-p" data-toggle="modal" data-target="#description<?php echo e(isset($item->id) ? $item->id : 0); ?>"><?php echo e($item->title); ?></td>
                            <td class="text-center"><a href="<?php echo e(isset($item->image) ? $item->image : ''); ?>"><?php echo e(trans('admin.view')); ?></a> </td>
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Requests','Future Courses']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>