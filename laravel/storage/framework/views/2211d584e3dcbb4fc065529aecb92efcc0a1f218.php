        ...
        <table class="table ucp-table" id="buy-table">
            ...
            <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="text-center">
                    ...
                    <td class="cell-ta"><a href="/product/<?php echo e(isset($item->content->id) ? $item->content->id : 0); ?>"><?php echo e(isset($item->content->title) ? $item->content->title : ''); ?></a></td>
                    <td class="cell-ta"><a href="/category/<?php echo e(isset($item->content->category->class) ? $item->content->category->class : ''); ?>"><?php echo e(isset($item->content->category->title) ? $item->content->category->title : ''); ?></a></td>
                    <td class="cell-ta"><a href="/profile/<?php echo e(isset($item->content->user->id) ? $item->content->user->id : 0); ?>"><?php echo e(isset($item->content->user->name) ? $item->content->user->name : $item->content->user->username); ?></a></td>
                    <td>
                    ...
                    <td><?php echo e(currencySign()); ?><?php echo e(isset($item->transaction->price) ? $item->transaction->price : 0); ?></td>
                    <td>
                        <?php echo e(date('Y/m/d',$item->create_at)); ?>
                    ...
                    <td>
                        ...
                        <?php if($item->type == 'post'): ?>
                            <a class="gray-s" href="#" data-toggle="modal" data-target="#post<?php echo e(isset($item->id) ? $item->id : 0); ?>" title="Shipping Detail"><span class="crticon mdi mdi-package"></span></a>
                        <?php endif; ?>
                        <a class="gray-s" href="/product/<?php echo e(isset($item->content->id) ? $item->content->id : 0); ?>" title="Download"><span class="crticon mdi mdi-arrow-down-thick"></span></a>
                        <a class="gray-s" href="/product/<?php echo e(isset($item->content->id) ? $item->content->id : 0); ?>#blog-comment-scroll" title="Leave comment"><span class="crticon mdi mdi-comment-plus"></span></a>
                        <a class="gray-s" target="_blank" href="/user/video/buy/print/<?php echo e(isset($item->id) ? $item->id : 0); ?>/" title="View invoice"><span class="crticon mdi mdi-printer"></span></a>
                    </td>
                </tr>
                        ...
                        <form class="form form-horizontal" method="post" action="/user/video/buy/confirm/<?php echo e(isset($item->id) ? $item->id : 0); ?>">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p> <?php echo e(trans('main.tracking_code')); ?> <strong><?php if($item->post_code == null || $item->post_code == ''): ?><?php echo '<b class="red-s">Package not sent yet.</b>'; ?> <?php else: ?> <?php echo e(isset($item->post_code) ? $item->post_code : ''); ?> <?php endif; ?></strong></p>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php else: ?>
                                            <strong class="green-s"> <?php echo e(isset($item->post_confirm) ? $item->post_confirm : ''); ?> </strong>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <span class="pull-right star-rate" data-id="<?php echo e(isset($item->id) ? $item->id : 0); ?>" data-score="<?php echo e(isset($item->rate->rate) ? $item->rate->rate : 0); ?>"></span>
...
<?php echo $__env->make($user['vendor'] == 1?'user.layout.balancelayout':'user.layout_user.videolayout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>