                    ...
                    <div class="widget-summary">
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <div class="info">
                                    <strong class="amount"><?php echo e(isset($contentCount) ? $contentCount : 0); ?></strong>
                                </div>
                            </div>
                    ...
                    <div class="widget-summary">
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <div class="info">
                                    <strong class="amount"><?php echo e(isset($videoCount) ? $videoCount : 0); ?></strong>
                                </div>
                            </div>
                            <div class="summary-footer">
...
<?php echo $__env->make('admin.newlayout.layout',['breadcom'=>['Report','Courses']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>