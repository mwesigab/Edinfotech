                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select name="order" class="form-control">
                                ...
                                <option value="buya" <?php if(isset($_GET['order']) && $_GET['order']=='buya'): ?> selected <?php endif; ?>><?php echo e(trans('admin.purchases')); ?>-<?php echo e(trans('admin.ascending')); ?></option>
                                <option value="buyd" <?php if(isset($_GET['order']) && $_GET['order']=='buyd'): ?> selected <?php endif; ?>><?php echo e(trans('admin.purchases')); ?>-<?php echo e(trans('admin.descending')); ?></option>
                                <option value="contenta" <?php if(isset($_GET['order']) && $_GET['order']=='contenta'): ?> selected <?php endif; ?>><?php echo e(trans('admin.badges_tab_courses_count')); ?>-<?php echo e(trans('admin.ascending')); ?></option>
                                <option value="contentd" <?php if(isset($_GET['order']) && $_GET['order']=='contentd'): ?> selected <?php endif; ?>><?php echo e(trans('admin.badges_tab_courses_count')); ?>-<?php echo e(trans('admin.descending')); ?></option>
                                ...
                                <option value="seller" <?php if(isset($_GET['order']) && $_GET['order']=='seller'): ?> selected <?php endif; ?>><?php echo e(trans('admin.disabled_users')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <table class="table table-bordered table-striped mb-none m-b-0" id="datatable-details">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <th class="text-center"><a href="/admin/content/user/<?php echo e($user->id); ?>"><?php echo e(isset($user->contents_count) ? $user->contents_count : 0); ?></a></th>
                            <th class="text-center"><a href="/admin/buysell/list/?buyer=<?php echo e($user->id); ?>"><?php echo e(isset($user->buys_count) ? $user->buys_count : 0); ?></a></th>
                            <th class="text-center"><a href="/admin/buysell/list/?user=<?php echo e($user->id); ?>"><?php echo e(isset($user->sells_count) ? $user->sells_count : 0); ?></a></th>
