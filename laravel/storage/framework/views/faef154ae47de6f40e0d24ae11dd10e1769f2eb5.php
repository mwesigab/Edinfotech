                    ...
                    <div class="steps" id="step1">
                        <form method="post" id="step-1-form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <input type="text" name="title" placeholder="Course Title..." class="form-control" value="<?php echo e(isset($item->title) ? $item->title : ''); ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 tab-con" for="inputDefault"><?php echo e(trans('main.description')); ?></label>
                                <div class="col-md-10 tab-con">
                                    <textarea class="form-control editor-te editor-te-h" placeholder="You can import HTML..." name="content" required><?php echo isset($item->content) ? $item->content : ''; ?></textarea>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="steps dnone" id="step2">
                        <form method="post" id="step-2-form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <input type="text" data-role="tagsinput" placeholder="Press enter to save tag." name="tag" value="<?php echo e(isset($item->tag) ? $item->tag : ''); ?>" class="form-control text-center">
                                </div>
                            </div>
                            <div class="form-group">
                                                ...
                                                <optgroup label="<?php echo e(isset($menu->title) ? $menu->title : ''); ?>">
                                                    <?php if(count($menu->childs)>0): ?>
                                                        <?php $__currentLoopData = $menu->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e(isset($sub->id) ? $sub->id : ''); ?>" <?php if($sub->id == $item->category_id): ?> selected <?php endif; ?>><?php echo e(isset($sub->title) ? $sub->title : ''); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php else: ?>
                                                        <option value="<?php echo e(isset($menu->id) ? $menu->id : ''); ?>" <?php if($menu->id == $item->category_id): ?> selected <?php endif; ?>><?php echo e(isset($menu->title) ? $menu->title : ''); ?></option>
                                                    <?php endif; ?>
                                                </optgroup>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="h-15"></div>
                            <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-11 col-md-offset-1 tab-con filters dnone" <?php if($menu->id != $item->category_id): ?> class="dnone" <?php endif; ?> id="filter<?php echo e(isset($menu->id) ? $menu->id : 0); ?>">
                                            ...
                                            <ul class="cat-filters-li pamaz">
                                                <ul class="submenu submenu-s">
                                                    <?php $__currentLoopData = $filter->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="second-input"><input type="checkbox" class="filter-tags dblock" id="tag<?php echo e(isset($tag->id) ? $tag->id : ''); ?>"  name="filters[]" value="<?php echo e(isset($tag->id) ? $tag->id : 0); ?>" <?php if(isset($item->filters) && in_array($tag->id,$item->filters->pluck('id')->toArray())): ?> checked <?php endif; ?>><label for="tag<?php echo e(isset($tag->id) ? $tag->id : ''); ?>"><span></span><?php echo e(isset($tag->tag) ? $tag->tag : ''); ?></label></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
                                            </ul>
                                        </div>
                    ...
                    <div class="steps dnone" id="step3">
                        ...
                        <form method="post" id="step-3-form-meta" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price" onkeypress="validate(event)" value="<?php echo e(isset($meta['price']) ? $meta['price'] : ''); ?>" class="form-control text-center numtostr" <?php if($item->price === 0): ?> disabled <?php endif; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="post_price" onkeypress="validate(event)" value="<?php echo e(isset($meta['post_price']) ? $meta['post_price'] : ''); ?>" class="form-control text-center numtostr" <?php if($item->post != 1): ?> disabled <?php endif; ?>>
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form method="post" id="step-3-form-subscribe" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price_3" onkeypress="validate(event)" value="<?php echo e(isset($item->price_3) ? $item->price_3 : ''); ?>" class="form-control text-center">
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price_6" onkeypress="validate(event)" value="<?php echo e(isset($item->price_6) ? $item->price_6 : ''); ?>" class="form-control text-center">
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price_9" onkeypress="validate(event)" value="<?php echo e(isset($item->price_9) ? $item->price_9 : ''); ?>" class="form-control text-center">
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 tab-con">
                                    <div class="input-group">
                                        <input type="number" name="price_12" onkeypress="validate(event)" value="<?php echo e(isset($item->price_12) ? $item->price_12 : ''); ?>" class="form-control text-center">
                                        <span class="input-group-addon click-for-upload img-icon-s"><?php echo e(currencySign()); ?></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body no-absolute-content">
                                        <form method="post" id="step-3-form-precourse">
                                            <input type="hidden" name="precourse" id="precourse" value="<?php echo e(isset($meta['precourse']) ? $meta['precourse'] : ''); ?>">
                                        </form>
                                        <ul class="pre-course-title-container">
                                            <?php $__currentLoopData = $preCourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li><?php echo e(isset($prec->title) ? $prec->title : ''); ?>&nbsp;(VT-<?php echo e(isset($prec->id) ? $prec->id : 0); ?>)<i class="fa fa-times delete-course" cid="<?php echo e(isset($prec->id) ? $prec->id : 0); ?>"></i></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="cover" placeholder="Prefered :410*730px" dir="ltr" value="<?php echo e(isset($meta['cover']) ? $meta['cover'] : ''); ?>" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="thumbnail" placeholder="Prefered :155*263px" dir="ltr" value="<?php echo e(isset($meta['thumbnail']) ? $meta['thumbnail'] : ''); ?>" class="form-control">
                                        <span class="input-group-addon click-for-upload img-icon-s"><span class="formicon mdi mdi-arrow-up-thick"></span></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="video" placeholder="Prefered :1-3 mins"  dir="ltr" value="<?php echo e(isset($meta['video']) ? $meta['video'] : ''); ?>" class="form-control">
                                        <span class="input-group-addon click-for-upload img-icon-s"><span class="formicon mdi mdi-arrow-up-thick"></span></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10 tab-con">
                                    <div class="input-group document-input">
                                        ...
                                        <input type="text" name="document" id="document-addon" dir="ltr" value="<?php echo e(isset($meta['document']) ? $meta['document'] : ''); ?>" class="form-control">
