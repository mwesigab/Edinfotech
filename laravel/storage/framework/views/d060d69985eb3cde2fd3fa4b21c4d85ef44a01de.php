    ...
    <div class="container">
        <div class="col-md-12 col-xs-12">
            <ul class="nav nav-tabs nav-justified panel-tabs" role="tablist">
                <li class="<?php echo $__env->yieldContent('tab1'); ?>"><a href="/user/ticket/support">
                        <span class="submicon mdi mdi-headset"></span>
                        <?php echo e(trans('main.courses_sup')); ?></a></li>
                <li class="<?php echo $__env->yieldContent('tab2'); ?>"><a href="/user/ticket/comments">
                        <span class="submicon mdi mdi-message-bulleted"></span>
                        <?php echo e(trans('main.comments')); ?></a></li>
